...
function setRating(moves) {
    ...
    if (moves > rank3stars && moves < rank2stars) {
        $ratingStars.eq(2).removeClass('fa-thumbs-up').addClass('fa-thumbs-down');
        rating = 2;
    } else if (moves > rank2stars && moves < rank1stars) {
        $ratingStars.eq(1).removeClass('fa-thumbs-up').addClass('fa-thumbs-down');
        rating = 1;
    } else if (moves > rank1stars) {
        $ratingStars.eq(0).removeClass('fa-thumbs-up').addClass('fa-thumbs-down');
        rating = 0;
    }
    return {
        score: rating
